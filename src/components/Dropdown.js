...
//import downIcon from './assets/down.svg'; // Adjust the path as needed

const Dropdown = ({ grouping, setGrouping, sortedBy, setSortedBy }) => {
  const [showDropdowns, setShowDropdowns] = useState(false); // State to manage visibility

  const handleDisplayClick = () => {
    setShowDropdowns(!showDropdowns); // Toggle dropdown visibility
  };
  ...
  return (
    <div className="dropdown-container">
      ...
      {showDropdowns && ( // Conditional rendering of dropdowns
